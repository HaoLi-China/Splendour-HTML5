...
(function(a) {
    ...
    function y(c, d) {
        ...
        e.onreadystatechange = e.onload = function() {
            var a = e.readyState; ! d.done && (!a || /loaded|complete/.test(a)) && (d.done = !0, d())
        },
    ...
    i ? k.js = function() {
        ...
        s(a,
        function(d, e) {
            d != b && (d = r(d), c[d.name] = d, x(d, b && e == a.length - 2 ?
            function() {
                u(c) && p(b)
            }: null))
        });
    ...
    if (window.addEventListener) a.addEventListener("DOMContentLoaded", z, !1),
